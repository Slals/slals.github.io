...
- **Un disque dur SSD de 500go ou plus** : vous devrez télécharger la blockchain de Bitcoin qui fait plus de 140 giga octects. Je recommande un disque dur SSD (électronique) à préférer au disque dur mécanique qui a une moins bonne tolérance à la panne. J'ai personnellement un disque dur mécanique ;
